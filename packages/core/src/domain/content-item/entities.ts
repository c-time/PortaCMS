import { z } from 'zod';
import { ContentItemId } from '../shared/ids.js';
import { FieldSlugSchema, ContentItemSlugSchema } from '../shared/entities.js';
import { DataTypesSchema } from '../content-model/entities.js';
